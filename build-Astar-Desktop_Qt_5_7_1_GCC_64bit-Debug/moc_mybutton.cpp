...
QT_MOC_LITERAL(1, 9, 7), // "myClick"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 9), // "myButton*"
QT_MOC_LITERAL(4, 28, 1), // "p"
QT_MOC_LITERAL(5, 30, 9) // "btClicked"

    },
    "myButton\0myClick\0\0myButton*\0p\0btClicked"
};
...
void myButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->myClick((*reinterpret_cast< myButton*(*)>(_a[1]))); break;
        case 1: _t->btClicked(); break;
        default: ;
        }
        ...
        {
            typedef void (myButton::*_t)(myButton * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&myButton::myClick)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myButton::myClick(myButton * _t1)
{
